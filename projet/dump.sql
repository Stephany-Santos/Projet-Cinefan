...
ALTER TABLE artiste
ADD COLUMN cree_par VARCHAR(20) DEFAULT "deleted-user" REFERENCES utilisateur(pseudo) ON DELETE SET DEFAULT NOT NULL;
ALTER TABLE media
ADD COLUMN realise INT REFERENCES artiste(id_artiste) NOT NULL ON DELETE RESTRICT,
ADD COLUMN suite INT REFERENCES media(id_media), 
ADD COLUMN genre VARCHAR(50) REFERENCES genre(intitule),
ADD COLUMN cree_par VARCHAR(20) DEFAULT "deleted-user" REFERENCES utilisateur(pseudo) ON DELETE SET DEFAULT NOT NULL;
ALTER TABLE personnage
ADD COLUMN cree_par VARCHAR(20) DEFAULT "deleted-user" REFERENCES utilisateur(pseudo) ON DELETE SET DEFAULT NOT NULL,
ADD COLUMN media INT REFERENCES media(id_media) NOT NULL ON DELETE RESTRICT;
...
(1, NULL, 1, "réalisateur"),
(3, NULL, 1, "compositeur"),
(7, NULL, 1, "scénariste"),
(4, 1, 1, "doubleur"),     -- Lyn
(5, 2, 1, "doubleur");     -- Renn

INSERT INTO participe VALUES
(1, NULL, 2, "réalisateur"),
(3, NULL, 2, "compositeur"),
(8, NULL, 2, "scénariste"),
(4, 1, 2, "doubleur"),     -- Lyn
(5, 2, 2, "doubleur");     -- Renn

INSERT INTO participe VALUES
(1, NULL, 3, "réalisateur"),
(3, NULL, 3, "compositeur"),
(9, NULL, 3, "scénariste"),
(4, 1, 3, "doubleur"),
(5, 2, 3, "doubleur");

INSERT INTO participe VALUES
(2, NULL, 4, "réalisateur"),
(6, NULL, 4, "compositeur"),
(10, NULL, 4, "scénariste");


INSERT INTO participe VALUES
(2, NULL, 5, "réalisateur"),
(6, NULL, 5, "compositeur"),
(11, NULL, 5, "scénariste");

INSERT INTO participe VALUES
(3, NULL, 6, "réalisateur"),
(10, NULL, 6, "compositeur"),
(12, NULL, 6, "scénariste"),
(11, 3, 6, "doubleur");    -- Mae

INSERT INTO participe VALUES
(4, NULL, 7, "réalisateur"),
(12, NULL, 7, "scénariste"),
(13, NULL, 7, "compositeur");

INSERT INTO participe VALUES
(5, NULL, 8, "réalisateur"),
(14, NULL, 8, "compositeur"),
(15, NULL, 8, "scénariste");

INSERT INTO participe VALUES
(6, NULL, 9, "réalisateur"),
(16, NULL, 9, "compositeur"),
(17, NULL, 9, "scénariste");

INSERT INTO participe VALUES
(7, NULL, 10, "réalisateur"),
(18, NULL, 10, "compositeur"),
(19, NULL, 10, "scénariste");
